[![](https://img.shields.io/github/actions/workflow/status/soenneker/soenneker.runners.email.disposables/build-and-test.yml?style=for-the-badge)](https://github.com/soenneker/soenneker.runners.email.disposables/actions/workflows/build-and-test.yml)
...
[![](https://img.shields.io/github/actions/workflow/status/soenneker/soenneker.runners.email.disposables/codeql.yml?label=CodeQL&style=for-the-badge)](https://github.com/soenneker/soenneker.runners.email.disposables/actions/workflows/codeql.yml)

# Soenneker.Runners.Email.Disposables
